...
use crate::cfg::prelude::DynPrimFn;
use crate::cfg::prelude::FreePrimFn;
use crate::cfg::prelude::Prelude;
use crate::cfg::prelude::free_impl;
use crate::cfg::prelude::mode::FuncMode;
use crate::cfg::prelude::mut_impl;
...
impl Default for CfgPrelude {
    fn default() -> Self {
        CfgPrelude { new: new(), repr: repr(), import: import(), export: export(), with: with() }
    }
}

impl Prelude for CfgPrelude {

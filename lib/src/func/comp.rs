...
impl FreeComposite {
    pub(crate) fn call(&self, inner: &mut Ctx, input: Val) -> Val {
...
impl DynComposite {
    pub(crate) fn call(&self, inner: &mut Ctx, outer: DynRef<Val>, input: Val) -> Val {
